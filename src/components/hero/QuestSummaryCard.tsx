  ...
  if (migrationPending) {
    return (
      <div className="panel p-5 min-w-0 space-y-2">
        <p className="font-display text-xs text-dim tracking-widest">任務追蹤器</p>
